...
Procurement and transition project arising from the lecture capture decision in
`001-lt-ecosystem`. Consolidates Learning Capture and Learning Delivery tooling
(Echo360, Microsoft Teams, Zoom) into a single platform for 2027.

Inherits architecture principles from `000-global`
(`ARC-000-PRIN-v1.0.md`) and the RIFF review flow in `000-global/policies/`.
