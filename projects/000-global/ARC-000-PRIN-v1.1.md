...
> **Template Origin**: Official | **ArcKit Version**: 6.7.4 | **Command**: `/arckit:principles`
...
| 1.1 | 2026-07-28 | ArcKit AI | Scope unchanged. Enumerated the eight capability categories in Appendix VIII so Principle 2 is objectively assessable rather than referring to an unstated category set; cross-referenced the taxonomy from Principle 2 and Principle 19. Corrected Document Register source locations from `demo-inputs/` to the governed ArcKit paths (`projects/000-global/external/`, `projects/000-global/policies/`, `projects/001-lt-ecosystem/external/`). No principle statement, rationale, implication, or validation gate was altered. | PENDING | PENDING |
...
**What changed in v1.1**: Principle 2 requires every capability category to have a designated primary platform, but v1.0 did not state what those categories are — leaving the principle's central validation gate unassessable without reference to a document outside this one. The eight-category taxonomy is now enumerated in Appendix VIII and cross-referenced from the principles that depend on it. This is a clarity fix, not a change of position.
...
The capability categories against which this principle is assessed are the eight categories enumerated in Appendix VIII [PP-C22]. That set is the unit of analysis — a platform is not "outside the categories"; it is either mapped to one or more of them, or the taxonomy is amended through the same governance path as this document.
...
- A platform spanning several categories is mapped to each, and may be primary in one while being a declared secondary in another

**Validation Gates**:

- [ ] Every one of the eight capability categories has a designated primary platform
...
- Licensed-but-unconfigured capability is inventoried and visible during capability assessment, indexed against the eight categories in Appendix VIII [PP-C22]
...
- [ ] Licensed-but-unconfigured capability inventoried per platform and mapped to capability category
...
Principle 2 requires a designated primary platform per capability category, and Principle 19 requires unrealised licensed capability to be indexed against the same set. Those categories are reproduced here so both principles are assessable from this document alone [PP-C22].

| # | Category | Scope |
|---|----------|-------|
| 1 | Course Design | Design of courses — setting learning objectives, designing user interface and experience, determining look & feel and site aesthetics, preparing instructional strategies |
| 2 | Learning Resources | Creation, management, publication, curation and editing of learning resources and materials in a variety of digital formats |
| 3 | Learning Delivery | Delivery of course resources to students |
| 4 | Learning Capture | Capture of course delivery (lectures, performances, labs) for streaming or future consumption |
| 5 | Active Learning | Student engagement in learning (thinking, discussing, investigating, creating) across engagement with content, with other students, and with teachers |
| 6 | Collaboration | Groups working together to solve problems, complete tasks and learn new concepts |
| 7 | Assessment & Progress Tracking | Evaluation, measurement and documentation of academic readiness, learning progress, skill acquisition and educational needs — including ongoing feedback and tracking of milestones against learning outcomes |
| 8 | Evaluation & Analytics | Data access and analysis for monitoring and evaluation to inform course design |

**How the taxonomy is used**: every current and proposed tool is categorised against these eight categories to enable cross-system comparison, duplication analysis and rationalisation decisions [PP-C5]. The categories are deliberately capability-oriented rather than product-oriented — a single platform commonly spans several, and that is the condition Principle 2 exists to make explicit rather than to prohibit.

**Amending the taxonomy**: the category set is a governed artifact. Adding, merging, or removing a category follows the same approval path as this document (Section VI), because doing so changes what Principle 2's validation gates assess.
...
Principles 2 and 4 are read together: Principle 2 requires declared capability boundaries and Principle 4 permits discipline-specific tooling outside the core set. These are not in tension — a specialist tool adopted under Principle 4 is recorded as a declared boundary under Principle 2, not as an undeclared overlap. A specialist tool is still mapped to one or more of the eight capability categories; "specialist" describes why it was chosen, not an exemption from categorisation.
...
|--------|----------|------|-----------------|-------------|
| PP-D1 | consultant-brief.md | Engagement brief | `projects/001-lt-ecosystem/external/` | Consultant Engagement Brief — L&T Baseline Strategy, WP1–WP9 |
| PP-D2 | capability-taxonomy.md | Foundation artifact | `projects/000-global/external/` | Eight-category L&T capability taxonomy |
| PP-D3 | system-landscape.md | Foundation artifact | `projects/001-lt-ecosystem/external/` | System categorisation map with usage status and known integrations |
| PP-D4 | solution-governance-process.md | Foundation artifact | `projects/000-global/policies/` | RIFF Review governance and approval process |
| PP-D5 | requirements-register.md | Requirements input | `projects/001-lt-ecosystem/external/` | Consolidated academic survey requirements (REQ-001 to REQ-035) |
| PP-D6 | privacy-context.md | Compliance input | `projects/001-lt-ecosystem/external/` | Personal information inventory, data flows, Essential Eight self-assessment |
| PP-D7 | stakeholders.md | Engagement input | `projects/001-lt-ecosystem/external/` | Engagement stakeholder register |
...
| PP-C5 | PP-D2 | Preamble | Taxonomy | "Every current and proposed tool is categorised against this taxonomy to enable cross-system comparison, duplication analysis and rationalisation decisions." |
...
| PP-C22 | PP-D2 | Category table | Taxonomy | "Eight capability categories define the learning & teaching technology ecosystem." Categories: Course Design; Learning Resources; Learning Delivery; Learning Capture; Active Learning; Collaboration; Assessment & Progress Tracking; Evaluation & Analytics |

### Unreferenced Documents

| Filename | Source Location | Reason |
|----------|-----------------|--------|
| stakeholders.md (PP-D7) | `projects/001-lt-ecosystem/external/` | Read for document ownership and approval path; stakeholder analysis is produced separately by `/arckit:stakeholders` |
...
| Stamped at | 2026-07-28T12:15:36.454Z |
