...
- **ADR-011 (reserved, not yet raised)**: Course cloning automation approach (INT-004, NFR-M-002, R-007). Rollover creates unit offerings and therefore triggers role assignment; the two decisions share a dependency on E-006. **Corrected 2026-07-30**: this reference originally read "ADR-003", but ADR-003 was subsequently issued as *Logging and Observability Stack*; the course-cloning decision is re-reserved as ADR-011. See HLDR BLOCKING-08
...
| Build Wave | 2 |
| Build Target | `ADR-002` |
| Build Topic | Authoritative source for institutional role assignment |
| Stamped at | 2026-07-30T00:26:06.336Z |
